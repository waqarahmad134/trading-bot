          ...
          <DrawerBody>
            <div className="text-white bg-[#0a76b6] hover:bg-[#0098ff] ">
              <nav className="flex flex-col [&>a]:border-b-[1px] [&>a]:border-white [&>a]:p-2">
                ...
                <Link to={`/movie/Genre`}>Hindi Dubbed Movies</Link>
                <Link to={`/movie/Country`}>Punjabi</Link>
                <Link to={`/movie/waqar`}>English</Link>
                <Link to={`/movie/waqar`}>Movies By Actors</Link>
                <Link to={`/movie/waqar`}>Movies By Actress</Link>
                <Link to={`/movie/waqar`}>By Type</Link>
                <Link className="border-none" to={`/movie/waqar`}>
                  Shows / Series
                </Link>
              </nav>
            </div>
      ...
      <div className="text-white bg-white w-full">
        ...
        <div className="bg-[#082835] hidden md:block">
          <nav className="flex flex-wrap items-center [&>a]:border-r [&>a]:p-3 ">
            ...
            <Link>Indian Movies</Link>
            <Link to={`/genre/28`}>Hindi Dubbed Movies</Link>
            <Link to={`/genre/29`}>Punjabi</Link>
            <Link to={`/genre/30`}>English</Link>
            <Link to={`/genre/31`}>Movies By Actors</Link>
            <Link to={`/genre/32`}>Movies By Actress</Link>
            <Link to={`/genre/33`}>By Type</Link>
            <Link className="border-none" to={`/genre/34`}>
              Shows / Series
            </Link>
          </nav>
        </div>
